...
Set-Variable -Name "pathSuffix" -Value "_03_2018_Rel9" -Description "IPR NAME"
Set-Variable -Name "outputFolderBaseName" -Value "D:\Shared\BCDR\IPR\100 Percent IPR - March 2018\KC46_100_IPR_" -Description "Top level folder name for the output of our BCDR processing"
Set-Variable -Name "inputPathBaseFolder" -Value "R:\Feb 2018 - Release 9\CSDB\DVD" -Description "Source data location of the data to put into BCDR"
#endregion
#region BASE GLOBALS
$global:sd = Get-Date
