...
$d = Get-Date -Format yyyy-MMMM-dd-HH-mm-ss
# *****************************************************************************************************
$pathToDatamodules = "R:\Non CDRL Jan 2018 - Release 9\CSDB\DVD\IPB\S1000D\SDLLIVE\DMC*.XML"
<#
    S - T - O - P
   1. Change this path to point to the latest release of the IPB Data set for the report to work 
       - change the $pathToDatamodules variable above 
   2. Change the output path to the location that meets your needs. 
       - change the $reportpath variable value below
#>
